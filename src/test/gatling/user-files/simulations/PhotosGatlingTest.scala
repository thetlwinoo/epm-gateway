...
class PhotosGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Photos entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "id":null
                , "thumbnailImageUrl":"SAMPLE_TEXT"
                , "originalImageUrl":"SAMPLE_TEXT"
                , "bannerTallImageUrl":"SAMPLE_TEXT"
                , "bannerWideImageUrl":"SAMPLE_TEXT"
                , "circleImageUrl":"SAMPLE_TEXT"
                , "sharpenedImageUrl":"SAMPLE_TEXT"
                , "squareImageUrl":"SAMPLE_TEXT"
                , "watermarkImageUrl":"SAMPLE_TEXT"
                , "priority":"0"
                , "defaultInd":null
                }""")).asJson
            .check(status.is(201))
