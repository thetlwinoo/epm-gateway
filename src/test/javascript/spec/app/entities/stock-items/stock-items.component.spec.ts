...
import { StockItemsComponent } from 'app/entities/stock-items/stock-items.component';
...
describe('Component Tests', () => {
  describe('StockItems Management Component', () => {
    let comp: StockItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StockItemsComponent, '')
        .compileComponents();
