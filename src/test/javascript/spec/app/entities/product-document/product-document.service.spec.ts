    ...
    describe('Service methods', () => {
      ...
      it('should update a ProductDocument', () => {
        const returnedFromService = Object.assign(
          {
            videoUrl: 'BBBBBB',
            highlightsUrl: 'BBBBBB',
            longDescriptionUrl: 'BBBBBB',
            shortDescriptionUrl: 'BBBBBB',
            descriptionUrl: 'BBBBBB',
            careInstructionsUrl: 'BBBBBB',
            specialFeaturesUrl: 'BBBBBB',
            usageAndSideEffectsUrl: 'BBBBBB',
            safetyWarnningUrl: 'BBBBBB',
            productType: 'BBBBBB',
            modelName: 'BBBBBB',
            modelNumber: 'BBBBBB',
            fabricType: 'BBBBBB',
