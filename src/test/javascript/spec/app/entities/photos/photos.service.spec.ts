...
describe('Service Tests', () => {
  describe('Photos Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Photos(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Photos', () => {
        const returnedFromService = Object.assign(
          {
            thumbnailImageUrl: 'BBBBBB',
            originalImageUrl: 'BBBBBB',
            bannerTallImageUrl: 'BBBBBB',
            bannerWideImageUrl: 'BBBBBB',
            circleImageUrl: 'BBBBBB',
            sharpenedImageUrl: 'BBBBBB',
            squareImageUrl: 'BBBBBB',
            watermarkImageUrl: 'BBBBBB',
            priority: 1,
            defaultInd: true
          },
          elemDefault
