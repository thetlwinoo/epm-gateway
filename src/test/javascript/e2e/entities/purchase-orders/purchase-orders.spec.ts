...
describe('PurchaseOrders e2e test', () => {
  ...
  it('should load PurchaseOrders', async () => {
    ...
    expect(await purchaseOrdersComponentsPage.getTitle()).to.eq('epmgatewayApp.purchaseOrders.home.title');
  });
  ...
  it('should load create PurchaseOrders page', async () => {
    ...
    expect(await purchaseOrdersUpdatePage.getPageTitle()).to.eq('epmgatewayApp.purchaseOrders.home.createOrEditLabel');
  ...
  it('should create and save PurchaseOrders', async () => {
    ...
    expect(await purchaseOrdersUpdatePage.getExpectedDeliveryDateInput()).to.eq(
      '2000-12-31',
  ...
  it('should delete last PurchaseOrders', async () => {
    ...
    expect(await purchaseOrdersDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.purchaseOrders.delete.question');
