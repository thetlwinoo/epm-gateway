...
describe('CompareProducts e2e test', () => {
  ...
  it('should load CompareProducts', async () => {
    ...
    expect(await compareProductsComponentsPage.getTitle()).to.eq('epmgatewayApp.compareProducts.home.title');
  });
  ...
  it('should load create CompareProducts page', async () => {
    ...
    expect(await compareProductsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.compareProducts.home.createOrEditLabel');
  ...
  it('should delete last CompareProducts', async () => {
    ...
    expect(await compareProductsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.compareProducts.delete.question');
