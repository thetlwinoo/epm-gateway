...
describe('StockItemHoldings e2e test', () => {
  ...
  it('should load StockItemHoldings', async () => {
    ...
    expect(await stockItemHoldingsComponentsPage.getTitle()).to.eq('epmgatewayApp.stockItemHoldings.home.title');
  });
  ...
  it('should load create StockItemHoldings page', async () => {
    ...
    expect(await stockItemHoldingsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.stockItemHoldings.home.createOrEditLabel');
  ...
  it('should delete last StockItemHoldings', async () => {
    ...
    expect(await stockItemHoldingsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.stockItemHoldings.delete.question');
