...
describe('PersonEmailAddress e2e test', () => {
  ...
  it('should load PersonEmailAddresses', async () => {
    ...
    expect(await personEmailAddressComponentsPage.getTitle()).to.eq('epmgatewayApp.personEmailAddress.home.title');
  });
  ...
  it('should load create PersonEmailAddress page', async () => {
    ...
    expect(await personEmailAddressUpdatePage.getPageTitle()).to.eq('epmgatewayApp.personEmailAddress.home.createOrEditLabel');
  ...
  it('should delete last PersonEmailAddress', async () => {
    ...
    expect(await personEmailAddressDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.personEmailAddress.delete.question');
