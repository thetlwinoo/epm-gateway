...
describe('PurchaseOrderLines e2e test', () => {
  ...
  it('should load PurchaseOrderLines', async () => {
    ...
    expect(await purchaseOrderLinesComponentsPage.getTitle()).to.eq('epmgatewayApp.purchaseOrderLines.home.title');
  });
  ...
  it('should load create PurchaseOrderLines page', async () => {
    ...
    expect(await purchaseOrderLinesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.purchaseOrderLines.home.createOrEditLabel');
  ...
  it('should create and save PurchaseOrderLines', async () => {
    ...
    expect(await purchaseOrderLinesUpdatePage.getLastReceiptDateInput()).to.eq(
      '2000-12-31',
  ...
  it('should delete last PurchaseOrderLines', async () => {
    ...
    expect(await purchaseOrderLinesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.purchaseOrderLines.delete.question');
