...
describe('UploadActionTypes e2e test', () => {
  ...
  it('should load UploadActionTypes', async () => {
    ...
    expect(await uploadActionTypesComponentsPage.getTitle()).to.eq('epmgatewayApp.uploadActionTypes.home.title');
  });
  ...
  it('should load create UploadActionTypes page', async () => {
    ...
    expect(await uploadActionTypesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.uploadActionTypes.home.createOrEditLabel');
  ...
  it('should delete last UploadActionTypes', async () => {
    ...
    expect(await uploadActionTypesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.uploadActionTypes.delete.question');
