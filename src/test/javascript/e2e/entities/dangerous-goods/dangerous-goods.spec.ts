...
describe('DangerousGoods e2e test', () => {
  ...
  it('should load DangerousGoods', async () => {
    ...
    expect(await dangerousGoodsComponentsPage.getTitle()).to.eq('epmgatewayApp.dangerousGoods.home.title');
  });
  ...
  it('should load create DangerousGoods page', async () => {
    ...
    expect(await dangerousGoodsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.dangerousGoods.home.createOrEditLabel');
  ...
  it('should delete last DangerousGoods', async () => {
    ...
    expect(await dangerousGoodsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.dangerousGoods.delete.question');
