...
describe('UploadTransactions e2e test', () => {
  ...
  it('should load UploadTransactions', async () => {
    ...
    expect(await uploadTransactionsComponentsPage.getTitle()).to.eq('epmgatewayApp.uploadTransactions.home.title');
  });
  ...
  it('should load create UploadTransactions page', async () => {
    ...
    expect(await uploadTransactionsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.uploadTransactions.home.createOrEditLabel');
  ...
  it('should create and save UploadTransactions', async () => {
    ...
    await promise.all([
      ...
      uploadTransactionsUpdatePage.statusSelectLastOption(),
  ...
  it('should delete last UploadTransactions', async () => {
    ...
    expect(await uploadTransactionsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.uploadTransactions.delete.question');
