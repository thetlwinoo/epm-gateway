...
describe('ProductBrand e2e test', () => {
  ...
  it('should load ProductBrands', async () => {
    ...
    expect(await productBrandComponentsPage.getTitle()).to.eq('epmgatewayApp.productBrand.home.title');
  });
  ...
  it('should load create ProductBrand page', async () => {
    ...
    expect(await productBrandUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productBrand.home.createOrEditLabel');
  ...
  it('should delete last ProductBrand', async () => {
    ...
    expect(await productBrandDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productBrand.delete.question');
