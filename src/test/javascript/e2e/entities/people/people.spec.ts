...
describe('People e2e test', () => {
  ...
  it('should load People', async () => {
    ...
    expect(await peopleComponentsPage.getTitle()).to.eq('epmgatewayApp.people.home.title');
  });
  ...
  it('should load create People page', async () => {
    ...
    expect(await peopleUpdatePage.getPageTitle()).to.eq('epmgatewayApp.people.home.createOrEditLabel');
  ...
  /*  it('should create and save People', async () => {
        ...
        expect(await peopleUpdatePage.getEmailAddressInput()).to.eq('emailAddress', 'Expected EmailAddress value to be equals to emailAddress');
  ...
  /*  it('should delete last People', async () => {
        ...
        expect(await peopleDeleteDialog.getDialogTitle())
            .to.eq('epmgatewayApp.people.delete.question');
