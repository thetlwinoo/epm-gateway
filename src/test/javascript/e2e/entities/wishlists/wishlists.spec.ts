...
describe('Wishlists e2e test', () => {
  ...
  it('should load Wishlists', async () => {
    ...
    expect(await wishlistsComponentsPage.getTitle()).to.eq('epmgatewayApp.wishlists.home.title');
  });
  ...
  it('should load create Wishlists page', async () => {
    ...
    expect(await wishlistsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.wishlists.home.createOrEditLabel');
  ...
  it('should delete last Wishlists', async () => {
    ...
    expect(await wishlistsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.wishlists.delete.question');
