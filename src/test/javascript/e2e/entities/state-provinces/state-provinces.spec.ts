...
describe('StateProvinces e2e test', () => {
  ...
  it('should load StateProvinces', async () => {
    ...
    expect(await stateProvincesComponentsPage.getTitle()).to.eq('epmgatewayApp.stateProvinces.home.title');
  });
  ...
  it('should load create StateProvinces page', async () => {
    ...
    expect(await stateProvincesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.stateProvinces.home.createOrEditLabel');
  ...
  it('should delete last StateProvinces', async () => {
    ...
    expect(await stateProvincesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.stateProvinces.delete.question');
