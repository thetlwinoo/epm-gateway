...
describe('Materials e2e test', () => {
  ...
  it('should load Materials', async () => {
    ...
    expect(await materialsComponentsPage.getTitle()).to.eq('epmgatewayApp.materials.home.title');
  });
  ...
  it('should load create Materials page', async () => {
    ...
    expect(await materialsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.materials.home.createOrEditLabel');
  ...
  it('should delete last Materials', async () => {
    ...
    expect(await materialsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.materials.delete.question');
