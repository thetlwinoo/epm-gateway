...
describe('ColdRoomTemperatures e2e test', () => {
  ...
  it('should load ColdRoomTemperatures', async () => {
    ...
    expect(await coldRoomTemperaturesComponentsPage.getTitle()).to.eq('epmgatewayApp.coldRoomTemperatures.home.title');
  });
  ...
  it('should load create ColdRoomTemperatures page', async () => {
    ...
    expect(await coldRoomTemperaturesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.coldRoomTemperatures.home.createOrEditLabel');
  ...
  it('should delete last ColdRoomTemperatures', async () => {
    ...
    expect(await coldRoomTemperaturesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.coldRoomTemperatures.delete.question');
