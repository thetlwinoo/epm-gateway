...
describe('BusinessEntityContact e2e test', () => {
  ...
  it('should load BusinessEntityContacts', async () => {
    ...
    expect(await businessEntityContactComponentsPage.getTitle()).to.eq('epmgatewayApp.businessEntityContact.home.title');
  });
  ...
  it('should load create BusinessEntityContact page', async () => {
    ...
    expect(await businessEntityContactUpdatePage.getPageTitle()).to.eq('epmgatewayApp.businessEntityContact.home.createOrEditLabel');
  ...
  it('should delete last BusinessEntityContact', async () => {
    ...
    expect(await businessEntityContactDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.businessEntityContact.delete.question');
