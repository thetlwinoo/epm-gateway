...
describe('PaymentTransactions e2e test', () => {
  ...
  it('should load PaymentTransactions', async () => {
    ...
    expect(await paymentTransactionsComponentsPage.getTitle()).to.eq('epmgatewayApp.paymentTransactions.home.title');
  });
  ...
  it('should load create PaymentTransactions page', async () => {
    ...
    expect(await paymentTransactionsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.paymentTransactions.home.createOrEditLabel');
  ...
  it('should delete last PaymentTransactions', async () => {
    ...
    expect(await paymentTransactionsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.paymentTransactions.delete.question');
