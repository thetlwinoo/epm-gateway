...
describe('Suppliers e2e test', () => {
  ...
  it('should load Suppliers', async () => {
    ...
    expect(await suppliersComponentsPage.getTitle()).to.eq('epmgatewayApp.suppliers.home.title');
  });
  ...
  it('should load create Suppliers page', async () => {
    ...
    expect(await suppliersUpdatePage.getPageTitle()).to.eq('epmgatewayApp.suppliers.home.createOrEditLabel');
  ...
  it('should delete last Suppliers', async () => {
    ...
    expect(await suppliersDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.suppliers.delete.question');
