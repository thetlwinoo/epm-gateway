...
describe('PackageTypes e2e test', () => {
  ...
  it('should load PackageTypes', async () => {
    ...
    expect(await packageTypesComponentsPage.getTitle()).to.eq('epmgatewayApp.packageTypes.home.title');
  });
  ...
  it('should load create PackageTypes page', async () => {
    ...
    expect(await packageTypesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.packageTypes.home.createOrEditLabel');
  ...
  it('should delete last PackageTypes', async () => {
    ...
    expect(await packageTypesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.packageTypes.delete.question');
