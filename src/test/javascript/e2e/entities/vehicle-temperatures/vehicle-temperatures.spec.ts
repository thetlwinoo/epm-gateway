...
describe('VehicleTemperatures e2e test', () => {
  ...
  it('should load VehicleTemperatures', async () => {
    ...
    expect(await vehicleTemperaturesComponentsPage.getTitle()).to.eq('epmgatewayApp.vehicleTemperatures.home.title');
  });
  ...
  it('should load create VehicleTemperatures page', async () => {
    ...
    expect(await vehicleTemperaturesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.vehicleTemperatures.home.createOrEditLabel');
  ...
  it('should delete last VehicleTemperatures', async () => {
    ...
    expect(await vehicleTemperaturesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.vehicleTemperatures.delete.question');
