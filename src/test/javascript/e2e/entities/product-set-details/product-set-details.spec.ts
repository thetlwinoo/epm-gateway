...
describe('ProductSetDetails e2e test', () => {
  ...
  it('should load ProductSetDetails', async () => {
    ...
    expect(await productSetDetailsComponentsPage.getTitle()).to.eq('epmgatewayApp.productSetDetails.home.title');
  });
  ...
  it('should load create ProductSetDetails page', async () => {
    ...
    expect(await productSetDetailsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productSetDetails.home.createOrEditLabel');
  ...
  it('should delete last ProductSetDetails', async () => {
    ...
    expect(await productSetDetailsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productSetDetails.delete.question');
