...
describe('ProductChoice e2e test', () => {
  ...
  it('should load ProductChoices', async () => {
    ...
    expect(await productChoiceComponentsPage.getTitle()).to.eq('epmgatewayApp.productChoice.home.title');
  });
  ...
  it('should load create ProductChoice page', async () => {
    ...
    expect(await productChoiceUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productChoice.home.createOrEditLabel');
  ...
  it('should delete last ProductChoice', async () => {
    ...
    expect(await productChoiceDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productChoice.delete.question');
