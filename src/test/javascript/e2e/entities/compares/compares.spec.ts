...
describe('Compares e2e test', () => {
  ...
  it('should load Compares', async () => {
    ...
    expect(await comparesComponentsPage.getTitle()).to.eq('epmgatewayApp.compares.home.title');
  });
  ...
  it('should load create Compares page', async () => {
    ...
    expect(await comparesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.compares.home.createOrEditLabel');
  ...
  it('should delete last Compares', async () => {
    ...
    expect(await comparesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.compares.delete.question');
