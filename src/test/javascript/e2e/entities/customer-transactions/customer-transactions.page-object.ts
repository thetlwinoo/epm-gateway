...
export class CustomerTransactionsUpdatePage {
  ...
  transactionOccurWhenInput = element(by.id('field_transactionOccurWhen'));
  ...
  async setTransactionOccurWhenInput(transactionOccurWhen) {
    await this.transactionOccurWhenInput.sendKeys(transactionOccurWhen);
  }

  async getTransactionOccurWhenInput() {
    return await this.transactionOccurWhenInput.getAttribute('value');
  }
  ...
  async paymentTransactionSelectLastOption(timeout?: number) {
