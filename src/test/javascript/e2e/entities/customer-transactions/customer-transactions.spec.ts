...
describe('CustomerTransactions e2e test', () => {
  ...
  it('should load CustomerTransactions', async () => {
    ...
    expect(await customerTransactionsComponentsPage.getTitle()).to.eq('epmgatewayApp.customerTransactions.home.title');
  });
  ...
  it('should load create CustomerTransactions page', async () => {
    ...
    expect(await customerTransactionsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.customerTransactions.home.createOrEditLabel');
  ...
  it('should create and save CustomerTransactions', async () => {
    ...
    await customerTransactionsComponentsPage.clickOnCreateButton();
    await promise.all([
      customerTransactionsUpdatePage.setTransactionOccurWhenInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
    ...
    expect(await customerTransactionsUpdatePage.getTransactionOccurWhenInput()).to.contain(
      '2001-01-01T02:30',
      'Expected transactionOccurWhen value to be equals to 2000-12-31'
    );
  ...
  it('should delete last CustomerTransactions', async () => {
    ...
    expect(await customerTransactionsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.customerTransactions.delete.question');
