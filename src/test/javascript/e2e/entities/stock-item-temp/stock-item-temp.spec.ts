...
describe('StockItemTemp e2e test', () => {
  ...
  it('should load StockItemTemps', async () => {
    ...
    expect(await stockItemTempComponentsPage.getTitle()).to.eq('epmgatewayApp.stockItemTemp.home.title');
  });
  ...
  it('should load create StockItemTemp page', async () => {
    ...
    expect(await stockItemTempUpdatePage.getPageTitle()).to.eq('epmgatewayApp.stockItemTemp.home.createOrEditLabel');
  ...
  it('should delete last StockItemTemp', async () => {
    ...
    expect(await stockItemTempDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.stockItemTemp.delete.question');
