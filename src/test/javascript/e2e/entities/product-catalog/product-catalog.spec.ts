...
describe('ProductCatalog e2e test', () => {
  ...
  it('should load ProductCatalogs', async () => {
    ...
    expect(await productCatalogComponentsPage.getTitle()).to.eq('epmgatewayApp.productCatalog.home.title');
  });
  ...
  it('should load create ProductCatalog page', async () => {
    ...
    expect(await productCatalogUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productCatalog.home.createOrEditLabel');
  ...
  it('should delete last ProductCatalog', async () => {
    ...
    expect(await productCatalogDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productCatalog.delete.question');
