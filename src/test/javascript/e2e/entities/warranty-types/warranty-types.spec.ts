...
describe('WarrantyTypes e2e test', () => {
  ...
  it('should load WarrantyTypes', async () => {
    ...
    expect(await warrantyTypesComponentsPage.getTitle()).to.eq('epmgatewayApp.warrantyTypes.home.title');
  });
  ...
  it('should load create WarrantyTypes page', async () => {
    ...
    expect(await warrantyTypesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.warrantyTypes.home.createOrEditLabel');
  ...
  it('should delete last WarrantyTypes', async () => {
    ...
    expect(await warrantyTypesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.warrantyTypes.delete.question');
