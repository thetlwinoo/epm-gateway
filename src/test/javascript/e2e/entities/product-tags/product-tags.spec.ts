...
describe('ProductTags e2e test', () => {
  ...
  it('should load ProductTags', async () => {
    ...
    expect(await productTagsComponentsPage.getTitle()).to.eq('epmgatewayApp.productTags.home.title');
  });
  ...
  it('should load create ProductTags page', async () => {
    ...
    expect(await productTagsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productTags.home.createOrEditLabel');
  ...
  it('should delete last ProductTags', async () => {
    ...
    expect(await productTagsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productTags.delete.question');
