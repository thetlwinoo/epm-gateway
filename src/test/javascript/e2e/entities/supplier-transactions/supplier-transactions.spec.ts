...
describe('SupplierTransactions e2e test', () => {
  ...
  it('should load SupplierTransactions', async () => {
    ...
    expect(await supplierTransactionsComponentsPage.getTitle()).to.eq('epmgatewayApp.supplierTransactions.home.title');
  });
  ...
  it('should load create SupplierTransactions page', async () => {
    ...
    expect(await supplierTransactionsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.supplierTransactions.home.createOrEditLabel');
  ...
  it('should delete last SupplierTransactions', async () => {
    ...
    expect(await supplierTransactionsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.supplierTransactions.delete.question');
