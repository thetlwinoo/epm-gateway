...
describe('ShoppingCartItems e2e test', () => {
  ...
  it('should load ShoppingCartItems', async () => {
    ...
    expect(await shoppingCartItemsComponentsPage.getTitle()).to.eq('epmgatewayApp.shoppingCartItems.home.title');
  });
  ...
  it('should load create ShoppingCartItems page', async () => {
    ...
    expect(await shoppingCartItemsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.shoppingCartItems.home.createOrEditLabel');
  ...
  it('should delete last ShoppingCartItems', async () => {
    ...
    expect(await shoppingCartItemsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.shoppingCartItems.delete.question');
