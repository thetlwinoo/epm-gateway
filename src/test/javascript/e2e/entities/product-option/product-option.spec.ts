...
describe('ProductOption e2e test', () => {
  ...
  it('should load ProductOptions', async () => {
    ...
    expect(await productOptionComponentsPage.getTitle()).to.eq('epmgatewayApp.productOption.home.title');
  });
  ...
  it('should load create ProductOption page', async () => {
    ...
    expect(await productOptionUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productOption.home.createOrEditLabel');
  ...
  it('should delete last ProductOption', async () => {
    ...
    expect(await productOptionDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productOption.delete.question');
