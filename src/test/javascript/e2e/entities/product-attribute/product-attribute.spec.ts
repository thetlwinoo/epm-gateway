...
describe('ProductAttribute e2e test', () => {
  ...
  it('should load ProductAttributes', async () => {
    ...
    expect(await productAttributeComponentsPage.getTitle()).to.eq('epmgatewayApp.productAttribute.home.title');
  });
  ...
  it('should load create ProductAttribute page', async () => {
    ...
    expect(await productAttributeUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productAttribute.home.createOrEditLabel');
  ...
  it('should delete last ProductAttribute', async () => {
    ...
    expect(await productAttributeDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productAttribute.delete.question');
