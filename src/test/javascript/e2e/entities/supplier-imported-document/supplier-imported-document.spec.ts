...
describe('SupplierImportedDocument e2e test', () => {
  ...
  it('should load SupplierImportedDocuments', async () => {
    ...
    expect(await supplierImportedDocumentComponentsPage.getTitle()).to.eq('epmgatewayApp.supplierImportedDocument.home.title');
  });
  ...
  it('should load create SupplierImportedDocument page', async () => {
    ...
    expect(await supplierImportedDocumentUpdatePage.getPageTitle()).to.eq('epmgatewayApp.supplierImportedDocument.home.createOrEditLabel');
  ...
  it('should create and save SupplierImportedDocuments', async () => {
    ...
    await supplierImportedDocumentComponentsPage.clickOnCreateButton();
    await promise.all([
      supplierImportedDocumentUpdatePage.setDocumentUrlInput('documentUrl'),
      supplierImportedDocumentUpdatePage.documentTypeSelectLastOption(),
    ...
    expect(await supplierImportedDocumentUpdatePage.getDocumentUrlInput()).to.eq(
      'documentUrl',
      'Expected DocumentUrl value to be equals to documentUrl'
    );
  ...
  it('should delete last SupplierImportedDocument', async () => {
    ...
    expect(await supplierImportedDocumentDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.supplierImportedDocument.delete.question');
