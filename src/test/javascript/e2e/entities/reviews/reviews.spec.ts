...
describe('Reviews e2e test', () => {
  ...
  it('should load Reviews', async () => {
    ...
    expect(await reviewsComponentsPage.getTitle()).to.eq('epmgatewayApp.reviews.home.title');
  });
  ...
  it('should load create Reviews page', async () => {
    ...
    expect(await reviewsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.reviews.home.createOrEditLabel');
  ...
  it('should delete last Reviews', async () => {
    ...
    expect(await reviewsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.reviews.delete.question');
