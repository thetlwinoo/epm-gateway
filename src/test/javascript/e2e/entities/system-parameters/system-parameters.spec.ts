...
describe('SystemParameters e2e test', () => {
  ...
  it('should load SystemParameters', async () => {
    ...
    expect(await systemParametersComponentsPage.getTitle()).to.eq('epmgatewayApp.systemParameters.home.title');
  });
  ...
  it('should load create SystemParameters page', async () => {
    ...
    expect(await systemParametersUpdatePage.getPageTitle()).to.eq('epmgatewayApp.systemParameters.home.createOrEditLabel');
  ...
  it('should delete last SystemParameters', async () => {
    ...
    expect(await systemParametersDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.systemParameters.delete.question');
