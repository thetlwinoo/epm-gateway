...
describe('BusinessEntityAddress e2e test', () => {
  ...
  it('should load BusinessEntityAddresses', async () => {
    ...
    expect(await businessEntityAddressComponentsPage.getTitle()).to.eq('epmgatewayApp.businessEntityAddress.home.title');
  });
  ...
  it('should load create BusinessEntityAddress page', async () => {
    ...
    expect(await businessEntityAddressUpdatePage.getPageTitle()).to.eq('epmgatewayApp.businessEntityAddress.home.createOrEditLabel');
  ...
  it('should delete last BusinessEntityAddress', async () => {
    ...
    expect(await businessEntityAddressDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.businessEntityAddress.delete.question');
