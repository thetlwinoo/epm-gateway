...
describe('ShoppingCarts e2e test', () => {
  ...
  it('should load ShoppingCarts', async () => {
    ...
    expect(await shoppingCartsComponentsPage.getTitle()).to.eq('epmgatewayApp.shoppingCarts.home.title');
  });
  ...
  it('should load create ShoppingCarts page', async () => {
    ...
    expect(await shoppingCartsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.shoppingCarts.home.createOrEditLabel');
  ...
  it('should delete last ShoppingCarts', async () => {
    ...
    expect(await shoppingCartsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.shoppingCarts.delete.question');
