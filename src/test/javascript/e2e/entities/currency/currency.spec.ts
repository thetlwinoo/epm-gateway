...
describe('Currency e2e test', () => {
  ...
  it('should load Currencies', async () => {
    ...
    expect(await currencyComponentsPage.getTitle()).to.eq('epmgatewayApp.currency.home.title');
  });
  ...
  it('should load create Currency page', async () => {
    ...
    expect(await currencyUpdatePage.getPageTitle()).to.eq('epmgatewayApp.currency.home.createOrEditLabel');
  ...
  it('should delete last Currency', async () => {
    ...
    expect(await currencyDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.currency.delete.question');
