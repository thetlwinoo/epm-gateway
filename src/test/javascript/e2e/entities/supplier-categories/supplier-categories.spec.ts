...
describe('SupplierCategories e2e test', () => {
  ...
  it('should load SupplierCategories', async () => {
    ...
    expect(await supplierCategoriesComponentsPage.getTitle()).to.eq('epmgatewayApp.supplierCategories.home.title');
  });
  ...
  it('should load create SupplierCategories page', async () => {
    ...
    expect(await supplierCategoriesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.supplierCategories.home.createOrEditLabel');
  ...
  it('should delete last SupplierCategories', async () => {
    ...
    expect(await supplierCategoriesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.supplierCategories.delete.question');
