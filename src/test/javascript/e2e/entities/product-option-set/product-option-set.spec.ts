...
describe('ProductOptionSet e2e test', () => {
  ...
  it('should load ProductOptionSets', async () => {
    ...
    expect(await productOptionSetComponentsPage.getTitle()).to.eq('epmgatewayApp.productOptionSet.home.title');
  });
  ...
  it('should load create ProductOptionSet page', async () => {
    ...
    expect(await productOptionSetUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productOptionSet.home.createOrEditLabel');
  ...
  it('should delete last ProductOptionSet', async () => {
    ...
    expect(await productOptionSetDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productOptionSet.delete.question');
