...
describe('CurrencyRate e2e test', () => {
  ...
  it('should load CurrencyRates', async () => {
    ...
    expect(await currencyRateComponentsPage.getTitle()).to.eq('epmgatewayApp.currencyRate.home.title');
  });
  ...
  it('should load create CurrencyRate page', async () => {
    ...
    expect(await currencyRateUpdatePage.getPageTitle()).to.eq('epmgatewayApp.currencyRate.home.createOrEditLabel');
  ...
  it('should delete last CurrencyRate', async () => {
    ...
    expect(await currencyRateDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.currencyRate.delete.question');
