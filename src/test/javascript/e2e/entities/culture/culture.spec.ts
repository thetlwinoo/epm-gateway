...
describe('Culture e2e test', () => {
  ...
  it('should load Cultures', async () => {
    ...
    expect(await cultureComponentsPage.getTitle()).to.eq('epmgatewayApp.culture.home.title');
  });
  ...
  it('should load create Culture page', async () => {
    ...
    expect(await cultureUpdatePage.getPageTitle()).to.eq('epmgatewayApp.culture.home.createOrEditLabel');
  ...
  it('should delete last Culture', async () => {
    ...
    expect(await cultureDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.culture.delete.question');
