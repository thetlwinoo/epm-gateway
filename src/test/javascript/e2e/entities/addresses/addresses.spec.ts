...
describe('Addresses e2e test', () => {
  ...
  it('should load Addresses', async () => {
    ...
    expect(await addressesComponentsPage.getTitle()).to.eq('epmgatewayApp.addresses.home.title');
  });
  ...
  it('should load create Addresses page', async () => {
    ...
    expect(await addressesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.addresses.home.createOrEditLabel');
  ...
  it('should delete last Addresses', async () => {
    ...
    expect(await addressesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.addresses.delete.question');
