...
describe('StockItems e2e test', () => {
  ...
  it('should load StockItems', async () => {
    ...
    expect(await stockItemsComponentsPage.getTitle()).to.eq('epmgatewayApp.stockItems.home.title');
  });
  ...
  it('should load create StockItems page', async () => {
    ...
    expect(await stockItemsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.stockItems.home.createOrEditLabel');
  ...
  it('should delete last StockItems', async () => {
    ...
    expect(await stockItemsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.stockItems.delete.question');
