...
describe('ShipMethod e2e test', () => {
  ...
  it('should load ShipMethods', async () => {
    ...
    expect(await shipMethodComponentsPage.getTitle()).to.eq('epmgatewayApp.shipMethod.home.title');
  });
  ...
  it('should load create ShipMethod page', async () => {
    ...
    expect(await shipMethodUpdatePage.getPageTitle()).to.eq('epmgatewayApp.shipMethod.home.createOrEditLabel');
  ...
  it('should delete last ShipMethod', async () => {
    ...
    expect(await shipMethodDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.shipMethod.delete.question');
