...
describe('PhoneNumberType e2e test', () => {
  ...
  it('should load PhoneNumberTypes', async () => {
    ...
    expect(await phoneNumberTypeComponentsPage.getTitle()).to.eq('epmgatewayApp.phoneNumberType.home.title');
  });
  ...
  it('should load create PhoneNumberType page', async () => {
    ...
    expect(await phoneNumberTypeUpdatePage.getPageTitle()).to.eq('epmgatewayApp.phoneNumberType.home.createOrEditLabel');
  ...
  it('should delete last PhoneNumberType', async () => {
    ...
    expect(await phoneNumberTypeDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.phoneNumberType.delete.question');
