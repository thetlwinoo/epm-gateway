...
describe('Products e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productsComponentsPage.getTitle()).to.eq('epmgatewayApp.products.home.title');
  });
  ...
  it('should load create Products page', async () => {
    ...
    expect(await productsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.products.home.createOrEditLabel');
  ...
  it('should delete last Products', async () => {
    ...
    expect(await productsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.products.delete.question');
