...
describe('OrderLines e2e test', () => {
  ...
  it('should load OrderLines', async () => {
    ...
    expect(await orderLinesComponentsPage.getTitle()).to.eq('epmgatewayApp.orderLines.home.title');
  });
  ...
  it('should load create OrderLines page', async () => {
    ...
    expect(await orderLinesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.orderLines.home.createOrEditLabel');
  ...
  it('should delete last OrderLines', async () => {
    ...
    expect(await orderLinesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.orderLines.delete.question');
