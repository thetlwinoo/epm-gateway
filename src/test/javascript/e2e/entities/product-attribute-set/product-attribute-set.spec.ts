...
describe('ProductAttributeSet e2e test', () => {
  ...
  it('should load ProductAttributeSets', async () => {
    ...
    expect(await productAttributeSetComponentsPage.getTitle()).to.eq('epmgatewayApp.productAttributeSet.home.title');
  });
  ...
  it('should load create ProductAttributeSet page', async () => {
    ...
    expect(await productAttributeSetUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productAttributeSet.home.createOrEditLabel');
  ...
  it('should delete last ProductAttributeSet', async () => {
    ...
    expect(await productAttributeSetDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productAttributeSet.delete.question');
