...
describe('Orders e2e test', () => {
  ...
  it('should load Orders', async () => {
    ...
    expect(await ordersComponentsPage.getTitle()).to.eq('epmgatewayApp.orders.home.title');
  });
  ...
  it('should load create Orders page', async () => {
    ...
    expect(await ordersUpdatePage.getPageTitle()).to.eq('epmgatewayApp.orders.home.createOrEditLabel');
  ...
  it('should create and save Orders', async () => {
    ...
    expect(await ordersUpdatePage.getOrderDateInput()).to.eq('2000-12-31', 'Expected orderDate value to be equals to 2000-12-31');
    expect(await ordersUpdatePage.getDueDateInput()).to.eq('2000-12-31', 'Expected dueDate value to be equals to 2000-12-31');
    expect(await ordersUpdatePage.getShipDateInput()).to.eq('2000-12-31', 'Expected shipDate value to be equals to 2000-12-31');
  ...
  it('should delete last Orders', async () => {
    ...
    expect(await ordersDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.orders.delete.question');
