...
describe('PersonPhone e2e test', () => {
  ...
  it('should load PersonPhones', async () => {
    ...
    expect(await personPhoneComponentsPage.getTitle()).to.eq('epmgatewayApp.personPhone.home.title');
  });
  ...
  it('should load create PersonPhone page', async () => {
    ...
    expect(await personPhoneUpdatePage.getPageTitle()).to.eq('epmgatewayApp.personPhone.home.createOrEditLabel');
  ...
  it('should delete last PersonPhone', async () => {
    ...
    expect(await personPhoneDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.personPhone.delete.question');
