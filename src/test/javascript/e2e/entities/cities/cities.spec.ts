...
describe('Cities e2e test', () => {
  ...
  it('should load Cities', async () => {
    ...
    expect(await citiesComponentsPage.getTitle()).to.eq('epmgatewayApp.cities.home.title');
  });
  ...
  it('should load create Cities page', async () => {
    ...
    expect(await citiesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.cities.home.createOrEditLabel');
  ...
  it('should delete last Cities', async () => {
    ...
    expect(await citiesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.cities.delete.question');
