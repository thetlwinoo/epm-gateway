...
describe('WishlistProducts e2e test', () => {
  ...
  it('should load WishlistProducts', async () => {
    ...
    expect(await wishlistProductsComponentsPage.getTitle()).to.eq('epmgatewayApp.wishlistProducts.home.title');
  });
  ...
  it('should load create WishlistProducts page', async () => {
    ...
    expect(await wishlistProductsUpdatePage.getPageTitle()).to.eq('epmgatewayApp.wishlistProducts.home.createOrEditLabel');
  ...
  it('should delete last WishlistProducts', async () => {
    ...
    expect(await wishlistProductsDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.wishlistProducts.delete.question');
