...
describe('Customers e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customersComponentsPage.getTitle()).to.eq('epmgatewayApp.customers.home.title');
  });
  ...
  it('should load create Customers page', async () => {
    ...
    expect(await customersUpdatePage.getPageTitle()).to.eq('epmgatewayApp.customers.home.createOrEditLabel');
  ...
  it('should delete last Customers', async () => {
    ...
    expect(await customersDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.customers.delete.question');
