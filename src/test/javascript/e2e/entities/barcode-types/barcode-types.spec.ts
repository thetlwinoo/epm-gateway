...
describe('BarcodeTypes e2e test', () => {
  ...
  it('should load BarcodeTypes', async () => {
    ...
    expect(await barcodeTypesComponentsPage.getTitle()).to.eq('epmgatewayApp.barcodeTypes.home.title');
  });
  ...
  it('should load create BarcodeTypes page', async () => {
    ...
    expect(await barcodeTypesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.barcodeTypes.home.createOrEditLabel');
  ...
  it('should delete last BarcodeTypes', async () => {
    ...
    expect(await barcodeTypesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.barcodeTypes.delete.question');
