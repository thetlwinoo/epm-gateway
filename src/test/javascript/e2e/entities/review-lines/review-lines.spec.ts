...
describe('ReviewLines e2e test', () => {
  ...
  it('should load ReviewLines', async () => {
    ...
    expect(await reviewLinesComponentsPage.getTitle()).to.eq('epmgatewayApp.reviewLines.home.title');
  });
  ...
  it('should load create ReviewLines page', async () => {
    ...
    expect(await reviewLinesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.reviewLines.home.createOrEditLabel');
  ...
  it('should delete last ReviewLines', async () => {
    ...
    expect(await reviewLinesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.reviewLines.delete.question');
