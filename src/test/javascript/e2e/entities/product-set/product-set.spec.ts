...
describe('ProductSet e2e test', () => {
  ...
  it('should load ProductSets', async () => {
    ...
    expect(await productSetComponentsPage.getTitle()).to.eq('epmgatewayApp.productSet.home.title');
  });
  ...
  it('should load create ProductSet page', async () => {
    ...
    expect(await productSetUpdatePage.getPageTitle()).to.eq('epmgatewayApp.productSet.home.createOrEditLabel');
  ...
  it('should delete last ProductSet', async () => {
    ...
    expect(await productSetDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.productSet.delete.question');
