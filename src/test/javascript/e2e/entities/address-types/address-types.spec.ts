...
describe('AddressTypes e2e test', () => {
  ...
  it('should load AddressTypes', async () => {
    ...
    expect(await addressTypesComponentsPage.getTitle()).to.eq('epmgatewayApp.addressTypes.home.title');
  });
  ...
  it('should load create AddressTypes page', async () => {
    ...
    expect(await addressTypesUpdatePage.getPageTitle()).to.eq('epmgatewayApp.addressTypes.home.createOrEditLabel');
  ...
  it('should delete last AddressTypes', async () => {
    ...
    expect(await addressTypesDeleteDialog.getDialogTitle()).to.eq('epmgatewayApp.addressTypes.delete.question');
