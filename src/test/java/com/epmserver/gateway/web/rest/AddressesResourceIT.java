...
import com.epmserver.gateway.service.dto.AddressesCriteria;
import com.epmserver.gateway.service.AddressesQueryService;
...
public class AddressesResourceIT {
    ...
    private static final String DEFAULT_CONTACT_EMAIL_ADDRESS = "L@0r.R7";
    private static final String UPDATED_CONTACT_EMAIL_ADDRESS = "h@v.!";
     ...
     *
     * @see com.epmserver.gateway.repository.search.AddressesSearchRepositoryMockConfiguration
     */
    @Autowired
