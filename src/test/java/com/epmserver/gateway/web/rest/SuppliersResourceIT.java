...
public class SuppliersResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.SuppliersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchSuppliers() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);
        when(mockSuppliersSearchRepository.search(queryStringQuery("id:" + suppliers.getId())))
            .thenReturn(Collections.singletonList(suppliers));
