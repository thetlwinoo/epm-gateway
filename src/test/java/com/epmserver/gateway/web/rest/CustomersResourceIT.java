...
import com.epmserver.gateway.service.CustomersQueryService;
...
public class CustomersResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.CustomersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchCustomers() throws Exception {
        // Initialize the database
        customersRepository.saveAndFlush(customers);
        when(mockCustomersSearchRepository.search(queryStringQuery("id:" + customers.getId())))
