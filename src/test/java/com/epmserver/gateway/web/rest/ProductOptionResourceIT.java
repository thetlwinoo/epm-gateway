...
import com.epmserver.gateway.service.dto.ProductOptionCriteria;
import com.epmserver.gateway.service.ProductOptionQueryService;
...
public class ProductOptionResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.ProductOptionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProductOption() throws Exception {
        ...
        verify(mockProductOptionSearchRepository, times(1)).save(testProductOption);
    }
    ...
    public void createProductOptionWithExistingId() throws Exception {
        ...
        // Validate the ProductOption in Elasticsearch
        verify(mockProductOptionSearchRepository, times(0)).save(productOption);
    }
    ...
    public void deleteProductOption() throws Exception {
        ...
        // Validate the ProductOption in Elasticsearch
        verify(mockProductOptionSearchRepository, times(1)).deleteById(productOption.getId());
    }
    ...
    public void searchProductOption() throws Exception {
        // Initialize the database
        productOptionRepository.saveAndFlush(productOption);
        when(mockProductOptionSearchRepository.search(queryStringQuery("id:" + productOption.getId())))
            .thenReturn(Collections.singletonList(productOption));
