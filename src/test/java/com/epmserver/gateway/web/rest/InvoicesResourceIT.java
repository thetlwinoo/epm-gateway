...
import com.epmserver.gateway.service.dto.InvoicesCriteria;
import com.epmserver.gateway.service.InvoicesQueryService;
...
import com.epmserver.gateway.domain.enumeration.PaymentMethod;
import com.epmserver.gateway.domain.enumeration.InvoiceStatus;
/**
...
public class InvoicesResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.InvoicesSearchRepositoryMockConfiguration
     */
    @Autowired
    private InvoicesSearchRepository mockInvoicesSearchRepository;
    ...
    public void createInvoices() throws Exception {
        ...
        verify(mockInvoicesSearchRepository, times(1)).save(testInvoices);
    }
    ...
    public void createInvoicesWithExistingId() throws Exception {
        ...
        // Validate the Invoices in Elasticsearch
        verify(mockInvoicesSearchRepository, times(0)).save(invoices);
    }
    ...
    public void deleteInvoices() throws Exception {
        ...
        // Validate the Invoices in Elasticsearch
        verify(mockInvoicesSearchRepository, times(1)).deleteById(invoices.getId());
    }
    ...
    public void searchInvoices() throws Exception {
        // Initialize the database
        invoicesRepository.saveAndFlush(invoices);
        when(mockInvoicesSearchRepository.search(queryStringQuery("id:" + invoices.getId())))
            .thenReturn(Collections.singletonList(invoices));
        // Search the invoices
