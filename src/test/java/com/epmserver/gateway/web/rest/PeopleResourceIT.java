...
import com.epmserver.gateway.service.dto.PeopleCriteria;
import com.epmserver.gateway.service.PeopleQueryService;
...
import com.epmserver.gateway.domain.enumeration.Gender;
/**
...
public class PeopleResourceIT {
    ...
    private static final String DEFAULT_EMAIL_ADDRESS = "pj@k.7B";
    private static final String UPDATED_EMAIL_ADDRESS = "G@r.&%";
     ...
     *
     * @see com.epmserver.gateway.repository.search.PeopleSearchRepositoryMockConfiguration
     */
    @Autowired
