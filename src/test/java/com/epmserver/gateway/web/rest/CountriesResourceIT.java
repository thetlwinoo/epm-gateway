...
public class CountriesResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.CountriesSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchCountries() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);
        when(mockCountriesSearchRepository.search(queryStringQuery("id:" + countries.getId())))
            .thenReturn(Collections.singletonList(countries));
