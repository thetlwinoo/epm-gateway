...
import com.epmserver.gateway.service.dto.ProductAttributeCriteria;
import com.epmserver.gateway.service.ProductAttributeQueryService;
...
public class ProductAttributeResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.ProductAttributeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProductAttribute() throws Exception {
        ...
        verify(mockProductAttributeSearchRepository, times(1)).save(testProductAttribute);
    }
    ...
    public void createProductAttributeWithExistingId() throws Exception {
        ...
        // Validate the ProductAttribute in Elasticsearch
        verify(mockProductAttributeSearchRepository, times(0)).save(productAttribute);
    }
    ...
    public void deleteProductAttribute() throws Exception {
        ...
        // Validate the ProductAttribute in Elasticsearch
        verify(mockProductAttributeSearchRepository, times(1)).deleteById(productAttribute.getId());
    }
    ...
    public void searchProductAttribute() throws Exception {
        // Initialize the database
        productAttributeRepository.saveAndFlush(productAttribute);
        when(mockProductAttributeSearchRepository.search(queryStringQuery("id:" + productAttribute.getId())))
            .thenReturn(Collections.singletonList(productAttribute));
