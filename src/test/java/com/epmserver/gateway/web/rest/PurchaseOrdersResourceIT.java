...
import com.epmserver.gateway.service.dto.PurchaseOrdersCriteria;
import com.epmserver.gateway.service.PurchaseOrdersQueryService;
...
public class PurchaseOrdersResourceIT {
     ...
     *
     * @see com.epmserver.gateway.repository.search.PurchaseOrdersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    public void getAllPurchaseOrdersByExpectedDeliveryDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where expectedDeliveryDate is greater than or equal to DEFAULT_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldBeFound("expectedDeliveryDate.greaterThanOrEqual=" + DEFAULT_EXPECTED_DELIVERY_DATE);

        // Get all the purchaseOrdersList where expectedDeliveryDate is greater than or equal to UPDATED_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldNotBeFound("expectedDeliveryDate.greaterThanOrEqual=" + UPDATED_EXPECTED_DELIVERY_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByExpectedDeliveryDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where expectedDeliveryDate is less than or equal to DEFAULT_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldBeFound("expectedDeliveryDate.lessThanOrEqual=" + DEFAULT_EXPECTED_DELIVERY_DATE);

        // Get all the purchaseOrdersList where expectedDeliveryDate is less than or equal to SMALLER_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldNotBeFound("expectedDeliveryDate.lessThanOrEqual=" + SMALLER_EXPECTED_DELIVERY_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByExpectedDeliveryDateIsLessThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where expectedDeliveryDate is less than DEFAULT_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldNotBeFound("expectedDeliveryDate.lessThan=" + DEFAULT_EXPECTED_DELIVERY_DATE);

        // Get all the purchaseOrdersList where expectedDeliveryDate is less than UPDATED_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldBeFound("expectedDeliveryDate.lessThan=" + UPDATED_EXPECTED_DELIVERY_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByExpectedDeliveryDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where expectedDeliveryDate is greater than DEFAULT_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldNotBeFound("expectedDeliveryDate.greaterThan=" + DEFAULT_EXPECTED_DELIVERY_DATE);

        // Get all the purchaseOrdersList where expectedDeliveryDate is greater than SMALLER_EXPECTED_DELIVERY_DATE
        defaultPurchaseOrdersShouldBeFound("expectedDeliveryDate.greaterThan=" + SMALLER_EXPECTED_DELIVERY_DATE);
    }
