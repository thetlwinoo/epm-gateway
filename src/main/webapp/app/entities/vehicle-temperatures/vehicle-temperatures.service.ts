...
export class VehicleTemperaturesService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/vehicle-temperatures';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IVehicleTemperatures[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
