...
export class PersonPhoneService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/person-phones';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPersonPhone[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
