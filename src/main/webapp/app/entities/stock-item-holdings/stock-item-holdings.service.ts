...
export class StockItemHoldingsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/stock-item-holdings';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IStockItemHoldings[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
