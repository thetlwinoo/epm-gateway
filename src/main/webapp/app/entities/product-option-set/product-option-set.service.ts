...
export class ProductOptionSetService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-option-sets';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductOptionSet[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
