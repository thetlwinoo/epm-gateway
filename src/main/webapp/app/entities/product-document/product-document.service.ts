...
export class ProductDocumentService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-documents';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductDocument[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
