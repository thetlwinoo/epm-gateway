...
export class PersonEmailAddressService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/person-email-addresses';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPersonEmailAddress[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
