...
export class ProductSetDetailsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-set-details';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductSetDetails[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
