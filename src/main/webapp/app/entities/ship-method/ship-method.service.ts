...
export class ShipMethodService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/ship-methods';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IShipMethod[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
