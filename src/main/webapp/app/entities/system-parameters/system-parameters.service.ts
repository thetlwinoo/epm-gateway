...
export class SystemParametersService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/system-parameters';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ISystemParameters[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
