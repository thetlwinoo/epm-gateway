...
export class AddressTypesService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/address-types';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IAddressTypes[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
