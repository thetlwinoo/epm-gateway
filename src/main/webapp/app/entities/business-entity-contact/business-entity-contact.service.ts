...
export class BusinessEntityContactService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/business-entity-contacts';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IBusinessEntityContact[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
