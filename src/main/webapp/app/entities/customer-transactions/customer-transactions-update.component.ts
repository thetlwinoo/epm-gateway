...
export class CustomerTransactionsUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    transactionOccurWhen: [null, [Validators.required]],
  ...
  updateForm(customerTransactions: ICustomerTransactions) {
    this.editForm.patchValue({
      ...
      transactionOccurWhen:
        customerTransactions.transactionOccurWhen != null ? customerTransactions.transactionOccurWhen.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): ICustomerTransactions {
    return {
      ...
      transactionOccurWhen:
        this.editForm.get(['transactionOccurWhen']).value != null
          ? moment(this.editForm.get(['transactionOccurWhen']).value, DATE_TIME_FORMAT)
          : undefined,
