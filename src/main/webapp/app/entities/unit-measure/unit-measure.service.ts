...
export class UnitMeasureService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/unit-measures';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IUnitMeasure[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
