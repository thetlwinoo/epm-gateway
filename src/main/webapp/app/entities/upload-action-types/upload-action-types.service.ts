...
export class UploadActionTypesService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/upload-action-types';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IUploadActionTypes[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
