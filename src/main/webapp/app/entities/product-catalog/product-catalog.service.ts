...
export class ProductCatalogService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-catalogs';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductCatalog[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
