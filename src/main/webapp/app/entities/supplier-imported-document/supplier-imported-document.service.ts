...
export class SupplierImportedDocumentService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/supplier-imported-documents';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<ISupplierImportedDocument[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
