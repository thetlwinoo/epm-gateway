...
export class ProductBrandService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-brands';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductBrand[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
