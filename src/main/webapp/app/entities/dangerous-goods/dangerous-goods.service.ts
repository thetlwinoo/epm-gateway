...
export class DangerousGoodsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/dangerous-goods';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDangerousGoods[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
