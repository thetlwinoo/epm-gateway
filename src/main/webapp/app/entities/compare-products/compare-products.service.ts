...
export class CompareProductsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/compare-products';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICompareProducts[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
