...
export class BusinessEntityAddressService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/business-entity-addresses';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IBusinessEntityAddress[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
