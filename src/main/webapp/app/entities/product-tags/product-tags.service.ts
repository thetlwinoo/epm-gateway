...
export class ProductTagsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/product-tags';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductTags[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
