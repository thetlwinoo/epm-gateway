...
export class WishlistProductsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/wishlist-products';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IWishlistProducts[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
