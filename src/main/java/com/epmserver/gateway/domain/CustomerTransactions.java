...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "customertransactions")
public class CustomerTransactions implements Serializable {
    ...
    @NotNull
    @Column(name = "transaction_occur_when", nullable = false)
    private Instant transactionOccurWhen;
    ...
    public Instant getTransactionOccurWhen() {
        return transactionOccurWhen;
    }

    public CustomerTransactions transactionOccurWhen(Instant transactionOccurWhen) {
        this.transactionOccurWhen = transactionOccurWhen;
        return this;
    }

    public void setTransactionOccurWhen(Instant transactionOccurWhen) {
        this.transactionOccurWhen = transactionOccurWhen;
    }
    ...
    public String toString() {
        return "CustomerTransactions{" +
            "id=" + getId() +
            ", transactionOccurWhen='" + getTransactionOccurWhen() + "'" +
