...
/**
 * Criteria class for the {@link com.epmserver.gateway.domain.CustomerTransactions} entity. This class is used
 * in {@link com.epmserver.gateway.web.rest.CustomerTransactionsResource} to receive all the possible filtering options from
...
public class CustomerTransactionsCriteria implements Serializable, Criteria {
    ...
    private InstantFilter transactionOccurWhen;
    ...
    public CustomerTransactionsCriteria(CustomerTransactionsCriteria other){
        ...
        this.transactionOccurWhen = other.transactionOccurWhen == null ? null : other.transactionOccurWhen.copy();
    ...
    public InstantFilter getTransactionOccurWhen() {
        return transactionOccurWhen;
    }

    public void setTransactionOccurWhen(InstantFilter transactionOccurWhen) {
        this.transactionOccurWhen = transactionOccurWhen;
    }
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(transactionOccurWhen, that.transactionOccurWhen) &&
    ...
    public String toString() {
        return "CustomerTransactionsCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (transactionOccurWhen != null ? "transactionOccurWhen=" + transactionOccurWhen + ", " : "") +
