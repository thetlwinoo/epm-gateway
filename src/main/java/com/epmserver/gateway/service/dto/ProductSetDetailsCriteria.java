...
/**
 * Criteria class for the {@link com.epmserver.gateway.domain.ProductSetDetails} entity. This class is used
 * in {@link com.epmserver.gateway.web.rest.ProductSetDetailsResource} to receive all the possible filtering options from
