...
/**
 * Criteria class for the {@link com.epmserver.gateway.domain.UploadTransactions} entity. This class is used
 * in {@link com.epmserver.gateway.web.rest.UploadTransactionsResource} to receive all the possible filtering options from
...
public class UploadTransactionsCriteria implements Serializable, Criteria {
    /**
     * Class for filtering UploadTransactionStatus
     */
    public static class UploadTransactionStatusFilter extends Filter<UploadTransactionStatus> {

        public UploadTransactionStatusFilter() {
        }

        public UploadTransactionStatusFilter(UploadTransactionStatusFilter filter) {
            super(filter);
        }

        @Override
        public UploadTransactionStatusFilter copy() {
            return new UploadTransactionStatusFilter(this);
        }
    ...
    private UploadTransactionStatusFilter status;
    ...
    public UploadTransactionStatusFilter getStatus() {
        return status;
    }

    public void setStatus(UploadTransactionStatusFilter status) {
        this.status = status;
    }
