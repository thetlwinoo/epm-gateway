...
import com.epmserver.gateway.repository.ProductsExtendFilterRepository;
...
//                    _stockItems.setStockItemName(products.getProductName());
                    ...
                    for (Photos _photos : _stockItems.getPhotoLists()) {
                        if (_photos.getOriginalImageUrl() != null && _photos.getThumbnailImageUrl() != null) {
                ...
                for (StockItems _stockItems : products.getStockItemLists()) {
                    ...
                    for (Photos _photos : _stockItems.getPhotoLists()) {
                        if (_photos.getOriginalImageUrl() != null && _photos.getThumbnailImageUrl() != null) {
                            ...
                            photos.setOriginalImageUrl(_photos.getOriginalImageUrl());
//                            photos.originalPhotoBlobContentType(_photos.getOriginalPhotoBlobContentType());

                            photos.setThumbnailImageUrl(_photos.getThumbnailImageUrl());
//                            photos.thumbnailPhotoBlobContentType(_photos.getThumbnailPhotoBlobContentType());
            ...
            String _productnumber = ((Products) saveProduct).getName().replaceAll("[^a-zA-Z0-9]", "").toUpperCase();
