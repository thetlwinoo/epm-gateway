...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.UnitMeasure}.
 */
@RestController
@RequestMapping("/api")
public class UnitMeasureResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/unit-measures?query=:query} : search for the unitMeasure corresponding
     * to the query.
     *
     * @param query the query of the unitMeasure search.
     * @return the result of the search.
     */
    @GetMapping("/_search/unit-measures")
    public List<UnitMeasureDTO> searchUnitMeasures(@RequestParam String query) {
        log.debug("REST request to search UnitMeasures for query {}", query);
        return unitMeasureService.search(query);
    }
}
