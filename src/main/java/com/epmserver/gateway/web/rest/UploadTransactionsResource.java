...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.UploadTransactions}.
 */
@RestController
@RequestMapping("/api")
public class UploadTransactionsResource {
    ...
    public ResponseEntity<UploadTransactionsDTO> createUploadTransactions(@Valid @RequestBody UploadTransactionsDTO uploadTransactionsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<UploadTransactionsDTO> updateUploadTransactions(@Valid @RequestBody UploadTransactionsDTO uploadTransactionsDTO) throws URISyntaxException {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/upload-transactions?query=:query} : search for the uploadTransactions corresponding
     * to the query.
     *
     * @param query the query of the uploadTransactions search.
     * @return the result of the search.
     */
    @GetMapping("/_search/upload-transactions")
    public List<UploadTransactionsDTO> searchUploadTransactions(@RequestParam String query) {
        log.debug("REST request to search UploadTransactions for query {}", query);
        return uploadTransactionsService.search(query);
    }
}
