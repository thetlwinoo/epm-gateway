...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.SupplierCategories}.
 */
@RestController
@RequestMapping("/api")
public class SupplierCategoriesResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/supplier-categories?query=:query} : search for the supplierCategories corresponding
     * to the query.
     *
     * @param query the query of the supplierCategories search.
     * @return the result of the search.
     */
    @GetMapping("/_search/supplier-categories")
    public List<SupplierCategoriesDTO> searchSupplierCategories(@RequestParam String query) {
        log.debug("REST request to search SupplierCategories for query {}", query);
        return supplierCategoriesService.search(query);
    }
}
