...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Invoices}.
 */
@RestController
@RequestMapping("/api")
public class InvoicesResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/invoices?query=:query} : search for the invoices corresponding
     * to the query.
     *
    ...
    public List<InvoicesDTO> searchInvoices(@RequestParam String query) {
        ...
        return invoicesService.search(query);
    }
}
