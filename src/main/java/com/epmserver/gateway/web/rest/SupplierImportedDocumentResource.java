...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.SupplierImportedDocument}.
 */
@RestController
@RequestMapping("/api")
public class SupplierImportedDocumentResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/supplier-imported-documents?query=:query} : search for the supplierImportedDocument corresponding
     * to the query.
     *
     * @param query the query of the supplierImportedDocument search.
     * @return the result of the search.
     */
    @GetMapping("/_search/supplier-imported-documents")
    public List<SupplierImportedDocumentDTO> searchSupplierImportedDocuments(@RequestParam String query) {
        log.debug("REST request to search SupplierImportedDocuments for query {}", query);
        return supplierImportedDocumentService.search(query);
    }
}
