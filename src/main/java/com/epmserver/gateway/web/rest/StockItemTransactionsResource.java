...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.StockItemTransactions}.
 */
@RestController
@RequestMapping("/api")
public class StockItemTransactionsResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/stock-item-transactions?query=:query} : search for the stockItemTransactions corresponding
     * to the query.
     *
     * @param query the query of the stockItemTransactions search.
     * @return the result of the search.
     */
    @GetMapping("/_search/stock-item-transactions")
    public List<StockItemTransactionsDTO> searchStockItemTransactions(@RequestParam String query) {
        log.debug("REST request to search StockItemTransactions for query {}", query);
        return stockItemTransactionsService.search(query);
    }
}
