...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Compares}.
 */
@RestController
@RequestMapping("/api")
public class ComparesResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/compares?query=:query} : search for the compares corresponding
     * to the query.
     *
     * @param query the query of the compares search.
     * @return the result of the search.
     */
    @GetMapping("/_search/compares")
    public List<ComparesDTO> searchCompares(@RequestParam String query) {
        log.debug("REST request to search Compares for query {}", query);
        return comparesService.search(query);
    }
}
