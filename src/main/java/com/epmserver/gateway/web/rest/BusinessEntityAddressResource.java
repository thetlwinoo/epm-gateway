...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.BusinessEntityAddress}.
 */
@RestController
@RequestMapping("/api")
public class BusinessEntityAddressResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/business-entity-addresses?query=:query} : search for the businessEntityAddress corresponding
     * to the query.
     *
     * @param query the query of the businessEntityAddress search.
     * @return the result of the search.
     */
    @GetMapping("/_search/business-entity-addresses")
    public List<BusinessEntityAddressDTO> searchBusinessEntityAddresses(@RequestParam String query) {
        log.debug("REST request to search BusinessEntityAddresses for query {}", query);
        return businessEntityAddressService.search(query);
    }
}
