...
import com.epmserver.gateway.service.dto.SuppliersCriteria;
import com.epmserver.gateway.service.SuppliersQueryService;
...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Suppliers}.
 */
@RestController
@RequestMapping("/api")
public class SuppliersResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/suppliers?query=:query} : search for the suppliers corresponding
     * to the query.
     *
    ...
    public List<SuppliersDTO> searchSuppliers(@RequestParam String query) {
