...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.ProductSet}.
 */
@RestController
@RequestMapping("/api")
public class ProductSetResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/product-sets?query=:query} : search for the productSet corresponding
     * to the query.
     *
     * @param query the query of the productSet search.
     * @return the result of the search.
     */
    @GetMapping("/_search/product-sets")
    public List<ProductSetDTO> searchProductSets(@RequestParam String query) {
        log.debug("REST request to search ProductSets for query {}", query);
        return productSetService.search(query);
    }
}
