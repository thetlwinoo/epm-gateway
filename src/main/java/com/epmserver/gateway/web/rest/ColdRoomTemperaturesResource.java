...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.ColdRoomTemperatures}.
 */
@RestController
@RequestMapping("/api")
public class ColdRoomTemperaturesResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/cold-room-temperatures?query=:query} : search for the coldRoomTemperatures corresponding
     * to the query.
     *
     * @param query the query of the coldRoomTemperatures search.
     * @return the result of the search.
     */
    @GetMapping("/_search/cold-room-temperatures")
    public List<ColdRoomTemperaturesDTO> searchColdRoomTemperatures(@RequestParam String query) {
        log.debug("REST request to search ColdRoomTemperatures for query {}", query);
        return coldRoomTemperaturesService.search(query);
    }
}
