...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Culture}.
 */
@RestController
@RequestMapping("/api")
public class CultureResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/cultures?query=:query} : search for the culture corresponding
     * to the query.
     *
     * @param query the query of the culture search.
     * @return the result of the search.
     */
    @GetMapping("/_search/cultures")
    public List<CultureDTO> searchCultures(@RequestParam String query) {
        log.debug("REST request to search Cultures for query {}", query);
        return cultureService.search(query);
    }
}
