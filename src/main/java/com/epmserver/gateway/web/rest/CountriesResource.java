...
import com.epmserver.gateway.service.dto.CountriesCriteria;
import com.epmserver.gateway.service.CountriesQueryService;
...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Countries}.
 */
@RestController
@RequestMapping("/api")
public class CountriesResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/countries?query=:query} : search for the countries corresponding
     * to the query.
     *
    ...
    public List<CountriesDTO> searchCountries(@RequestParam String query) {
        log.debug("REST request to search Countries for query {}", query);
        return countriesService.search(query);
    }
}
