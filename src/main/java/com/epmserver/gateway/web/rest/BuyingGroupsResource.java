...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.BuyingGroups}.
 */
@RestController
@RequestMapping("/api")
public class BuyingGroupsResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/buying-groups?query=:query} : search for the buyingGroups corresponding
     * to the query.
     *
     * @param query the query of the buyingGroups search.
     * @return the result of the search.
     */
    @GetMapping("/_search/buying-groups")
    public List<BuyingGroupsDTO> searchBuyingGroups(@RequestParam String query) {
        log.debug("REST request to search BuyingGroups for query {}", query);
        return buyingGroupsService.search(query);
    }
}
