...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.AddressTypes}.
 */
@RestController
@RequestMapping("/api")
public class AddressTypesResource {
    ...
    */
    ...
    public List<AddressTypesDTO> searchAddressTypes(@RequestParam String query) {
        log.debug("REST request to search AddressTypes for query {}", query);
        return addressTypesService.search(query);
    }
}
