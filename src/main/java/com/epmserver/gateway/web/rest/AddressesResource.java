...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Addresses}.
 */
@RestController
@RequestMapping("/api")
public class AddressesResource {
    ...
    */
    ...
    public List<AddressesDTO> searchAddresses(@RequestParam String query) {
        log.debug("REST request to search Addresses for query {}", query);
        return addressesService.search(query);
    }
}
