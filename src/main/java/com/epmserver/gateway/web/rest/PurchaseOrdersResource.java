...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.PurchaseOrders}.
 */
@RestController
@RequestMapping("/api")
public class PurchaseOrdersResource {
    ...
    */
    ...
    public List<PurchaseOrdersDTO> searchPurchaseOrders(@RequestParam String query) {
        log.debug("REST request to search PurchaseOrders for query {}", query);
        return purchaseOrdersService.search(query);
    }
}
