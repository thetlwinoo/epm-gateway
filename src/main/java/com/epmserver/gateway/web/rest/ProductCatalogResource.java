...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.ProductCatalog}.
 */
@RestController
@RequestMapping("/api")
public class ProductCatalogResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/product-catalogs?query=:query} : search for the productCatalog corresponding
     * to the query.
     *
     * @param query the query of the productCatalog search.
     * @return the result of the search.
     */
    @GetMapping("/_search/product-catalogs")
    public List<ProductCatalogDTO> searchProductCatalogs(@RequestParam String query) {
        log.debug("REST request to search ProductCatalogs for query {}", query);
        return productCatalogService.search(query);
    }
}
