...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.ShipMethod}.
 */
@RestController
@RequestMapping("/api")
public class ShipMethodResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/ship-methods?query=:query} : search for the shipMethod corresponding
     * to the query.
     *
     * @param query the query of the shipMethod search.
     * @return the result of the search.
     */
    @GetMapping("/_search/ship-methods")
    public List<ShipMethodDTO> searchShipMethods(@RequestParam String query) {
        log.debug("REST request to search ShipMethods for query {}", query);
        return shipMethodService.search(query);
    }
}
