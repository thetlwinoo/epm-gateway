...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Reviews}.
 */
@RestController
@RequestMapping("/api")
public class ReviewsResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/reviews?query=:query} : search for the reviews corresponding
     * to the query.
     *
     * @param query the query of the reviews search.
     * @return the result of the search.
     */
    @GetMapping("/_search/reviews")
    public List<ReviewsDTO> searchReviews(@RequestParam String query) {
        log.debug("REST request to search Reviews for query {}", query);
        return reviewsService.search(query);
    }
}
