...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.PersonPhone}.
 */
@RestController
@RequestMapping("/api")
public class PersonPhoneResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/person-phones?query=:query} : search for the personPhone corresponding
     * to the query.
     *
     * @param query the query of the personPhone search.
     * @return the result of the search.
     */
    @GetMapping("/_search/person-phones")
    public List<PersonPhoneDTO> searchPersonPhones(@RequestParam String query) {
        log.debug("REST request to search PersonPhones for query {}", query);
        return personPhoneService.search(query);
    }
}
