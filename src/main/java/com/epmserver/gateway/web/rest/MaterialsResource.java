...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.Materials}.
 */
@RestController
@RequestMapping("/api")
public class MaterialsResource {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/materials?query=:query} : search for the materials corresponding
     * to the query.
     *
     * @param query the query of the materials search.
     * @return the result of the search.
     */
    @GetMapping("/_search/materials")
    public List<MaterialsDTO> searchMaterials(@RequestParam String query) {
        log.debug("REST request to search Materials for query {}", query);
        return materialsService.search(query);
    }
}
