...
/**
 * REST controller for managing {@link com.epmserver.gateway.domain.ProductAttribute}.
 */
@RestController
@RequestMapping("/api")
public class ProductAttributeResource {
    ...
    */
    ...
    public List<ProductAttributeDTO> searchProductAttributes(@RequestParam String query) {
        log.debug("REST request to search ProductAttributes for query {}", query);
        return productAttributeService.search(query);
    }
}
